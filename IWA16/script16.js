...
const MONTHS = [
  ...
  const createHtml = (athlete) => {
   ...
   const [latestRace]=races.slice().reverse();
    ...
    const raceDate=new Date(raceDate.date);
  ...
  const NM372=document.querySelector('sectio[data-athlete="NM372"]')
  NM372.appendChild(createHtml(data.response.data. NM372));
  
  
  const SV782=document.querySelector('sectio[data-athlete="SV782"]')
